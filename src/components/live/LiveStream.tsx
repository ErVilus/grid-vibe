...
const LiveStream = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-col md:flex-row bg-background-deep">
      ...
      <div className="w-full md:w-1/3 lg:w-1/4 xl:w-1/5 2xl:w-1/6 border-l border-white/5 flex flex-col">
        {/* Tabs Navigation */}
        <div className="flex border-b border-white/5 bg-background-carbon sticky top-0 z-40">
           <button 
